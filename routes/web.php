...
Route::group(['middleware' => 'sudahlogin'], function () {
    ...
    Route::get('pengguna/edit/{id_user}', [PenggunaController::class, 'edit']);
    Route::put('pengguna/update/{id_user}', [PenggunaController::class, 'update']);
    Route::get('pengguna/delete/{id_user}', [PenggunaController::class, 'destroy']);
    ...
    Route::get('laporan/penjualanPdf', [LaporanController::class, 'penjualanPdf']);
    Route::get('laporan/pembelian', [LaporanController::class, 'pembelian']);
    Route::get('laporan/pembelianPdf', [LaporanController::class, 'pembelianPdf']);
    Route::get('laporan/pengembalian', [LaporanController::class, 'pengembalian']);
    Route::get('laporan/pengembalianPdf', [LaporanController::class, 'pengembalianPdf']);
    Route::get('laporan/stok', [LaporanController::class, 'stok']);
    Route::get('laporan/stokPdf', [LaporanController::class, 'stokPdf']);
});
