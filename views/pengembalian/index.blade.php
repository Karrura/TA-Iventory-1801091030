			...
			<div class="card-body">
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td>{{$retur->nama}}</td>
						<td>{{$retur->jml}} {{$retur->nama_satuan}}</td>
						<td>{{$retur->descretur}}</td>
						<td>
							<a href="{{url('pengembalian/edit', $retur->id_pengembalian)}}"><i class="fa fa-edit"></i></a>

							<a href="{{url('pengembalian/delete', $retur->id_pengembalian)}}" onclick="return confirm('Anda Yakin Menghapus?')"><i class="fa fa-trash" style="color: grey"></i></a>
						</td>
					</tr>
					@endforeach
				</table>
