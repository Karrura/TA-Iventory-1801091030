...
<div class="wrapper">
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background: linear-gradient(to right, #343a40, #C5C5C5);">
    <!-- Left navbar links -->
    <ul class="navbar-nav" >
      <li class="nav-item" >
        <a class="nav-link" data-widget="pushmenu" href="{{url('dashboard')}}" role="button"><i class="fas fa-bars" style="color: white"></i></a>
      </li>
    ...
    <marquee><a class="nav-link text-bold" style="color: white">Selamat Datang {{ session()->get('nama')}}, Anda Berada Dalam Sistem Informasi Inventory</a></marquee>
  </nav>
  <!-- /.navbar -->
<div class="wrapper" >
  ...
  <center>
    ...
    <footer class="main-footer" style="background-color: #C5C5C5">
      <strong style="color: black">Copyright &copy; Tugas Akhir Inventory 2021 - Merisa Adha Azzahra - 1801091030</strong>
      <!-- All rights reserved. -->
