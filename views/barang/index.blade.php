			...
			<div class="card-body">
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td>
							<a href="{{url('barang/read', $b->id)}}"><i class="fa fa-eye" style="color: black"></i></a>
							<a href="{{url('barang/edit', $b->id)}}"><i class="fa fa-edit"></i></a>
							<a href="{{url('barang/delete', $b->id)}}" onclick="return confirm('Anda Yakin Menghapus?')"><i class="fa fa-trash" style="color: grey"></i></a>
						</td>
					</tr>
					@endforeach
				</table>
