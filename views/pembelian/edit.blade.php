    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <!-- <p style="font-size: 12px">1. Klik tombol 'Simpan Data' setelah menginputkan data </p>
                <p style="font-size: 12px">2. Klik tombol 'Lanjutkan' setelah data tersimpan </p>
                <p style="font-size: 12px">3. Jangan beralih ke menu lain sebelum menyelesaikan transaksi!</p>   -->      
            </div>
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                         <form enctype="multipart/form-data" method="post" action="{{url('/pembelian/update', $pembelian->id_pembelian)}}">
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <label for="faktur">Faktur Pembelian</label>
                                <input class="form-control" placeholder="Input Faktur Pembelian" type="text" name="faktur" value='{{$pembelian->faktur}}'>
                            </div>
                            <div class="form-group">
                                <label for="tgl">Tanggal Transaksi</label>
                                <input class="form-control" placeholder="Input Tanggal" type="date" name="tgl" value='{{$pembelian->tgl}}'>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="pemasok_id" name="pemasok_id" value="{{old('pemasok_id')}}">
                                    ...
                                    <option {{$k->id_pemasok == $pembelian->pemasok_id ? 'selected':''}} value="{{ $k->id_pemasok }}">{{ $k->nama_pemasok }}</option>
                                    @endforeach
                                </select>                            
                            </div>                            
                            <div class="form-group">
                                <label for="harga">Harga</label>
                                <input class="form-control" placeholder="Input Total Harga" type="number" name="harga" value='{{$pembelian->harga}}'>
                            </div>       
                            <div class="text-left">
                                <button type="submit" class="btn btn-primary">Simpan Data</button>
                            </div>
