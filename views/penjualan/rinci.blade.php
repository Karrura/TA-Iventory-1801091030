		...
		<div class="card-body">
			...
			<table class="table table-bordered">
					...
					<tr>
						...
						<td>{{$b->total}}</td>
						<td>
							<a href="{{url('detail_penjualan/delete', $b->id_detail)}}" onclick="return confirm('Anda Yakin Menghapus?')"><i class="fa fa-trash" style="color: grey"></i></a>						
						</td>
					</tr>
					@endforeach
					<tr>
