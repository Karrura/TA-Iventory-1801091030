				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td>
							...
							<a href="{{url('pengembalian/returAdd', $b->faktur)}}"><button class="btn btn-warning" style="background-color: #343a40;color: white; border-color: grey">Retur</button></a>
							
							<a href="{{url('penjualan/delete', $b->faktur)}}" onclick="return confirm('Anda Yakin Menghapus?')"><i class="fa fa-trash" style="color: grey"></i></a>
